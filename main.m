...
aScaled = mat2gray(a);
aColored = ind2rgb(im2uint8(aScaled), turbo(256)); % Apply colormap for visualization
...
bScaled = mat2gray(b);
bColored = ind2rgb(im2uint8(bScaled), parula(256)); % Apply colormap for visualization
